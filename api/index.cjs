...
// ── Routes ──────────────────────────────────────────────────────────────────
app.use("/api/stops", require("./routes/stops.cjs"));
app.use("/api/route", require("./routes/route.cjs"));
app.use("/api/live", require("./routes/live.cjs"));
app.use("/api/news", require("./routes/news.cjs"));
